...
public class WishListPage {
	...
	public void loginpass() 
	{
		...
		driver.findElement(By.xpath("//*[@id=\"input-email\"]")).sendKeys("soundaryariya27@gmail.com"); //enter registered emailid
		driver.findElement(By.xpath("//*[@id=\"input-password\"]")).sendKeys("sound"); //enter password
